...
my $timejs = `cat /tmp/particles1jstime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
my $timeem = `cat /tmp/particles1emtime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
my $timecpp = `cat /tmp/particles1cpptime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
