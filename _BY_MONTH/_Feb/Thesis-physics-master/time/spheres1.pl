...
my $timejs = `cat /tmp/spheres1jstime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
my $timeem = `cat /tmp/spheres1emtime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
my $timecpp = `cat /tmp/spheres1cpptime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
