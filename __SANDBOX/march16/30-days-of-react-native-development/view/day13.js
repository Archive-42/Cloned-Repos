...
class FunctionView extends Component {
  ...
  render() {
    return ( <
      ...
      <
      Text style = {
        this.props.numOfText == 140 ? styles.btnText : styles.activeBtnText
      } > 发推 < /Text> <
      /TouchableHighlight> <
      /View> <
      /View> <
      ...
      color = "#2aa2ef" > < /Icon> <
      /View> {
        this.state.images.map( ( image, index ) => < View key = {
            index
          }
          style = {
            styles.imageIcon
...
export default class extends Component {
  ...
  render() {
    return ( <
      ...
      onChangeText = {
        ( text ) => this._updateTextNum( text )
      } > < /TextInput> <
      FunctionView numOfText = {
        this.state.numOfText
      } > < /FunctionView> <
      /View>
    )
  }
