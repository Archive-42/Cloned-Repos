...
export class ReminderContainer extends Component {
  ...
  render() {
    ...
    list.push( <
      ...
      ref = "addList"
      onBlur = {
        ( event ) => this._addList( event.nativeEvent.text )
      }
      style = {
        styles.inputText
      }
    ...
    return ( <
      View style = {
        [ styles.reminderContainer, this.props.listStyle ]
      } >
      <
      Image style = {
        styles.reminderBg
