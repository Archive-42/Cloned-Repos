...
var useGetManyReference = function (resource, target, id, pagination, sort, filter, referencingResource, options) {
    ...
    function (state) { return ({
        ids: oneToMany_1.getIds(state, relatedTo) || defaultIds,
        allRecords: get_1.default(state.admin.resources, [resource, 'data'], defaultData),
    }); }, function (state) { return oneToMany_1.getTotal(state, relatedTo); }), _b = _a.data, ids = _b.ids, allRecords = _b.allRecords, total = _a.total, error = _a.error, loading = _a.loading, loaded = _a.loaded;
