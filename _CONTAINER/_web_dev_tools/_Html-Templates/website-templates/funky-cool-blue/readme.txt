This design was created originally for an e-commerce system, but it never got used. Anyway, I rather not put it to waste because I know someone out there will probably want to use it.
