...
my $timejs = `cat /tmp/particles2jstime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
my $timeem = `cat /tmp/particles2emtime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
my $timecpp = `cat /tmp/particles2cpptime.txt | grep real | sed 's/[ms]/ /g' | awk '{print \$3}'`;
