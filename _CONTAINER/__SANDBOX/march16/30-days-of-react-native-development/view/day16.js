  ...
  render() {
    return ( <
      View style = {
        ...
        this.state.hasSet && !this.state.enterApp ? < EnterPassword enterPassword = {
          () => this._enterPassword()
        }
        password = {
          this.state.password
        ...
        this.state.enterApp ? < View style = {
            styles.app
          } > < Text style = {
            styles.appText
          } > You are in the app! < /Text></View > : < View > < /View>} <
          /View>
      )
    }
  }
